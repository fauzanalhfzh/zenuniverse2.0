...
export function Hero() {
    return (
        <section className="bg-white dark:bg-[#0b1429]">
            <div className="mx-auto flex w-full max-w-[1200px] flex-col items-center gap-10 px-5 pt-10 pb-14 sm:px-10 xl:flex-row xl:gap-16 xl:px-[120px] xl:pt-16 xl:pb-[88px]">
                ...
                <div className="flex w-full flex-1 flex-col items-center gap-7 text-center">
                    <h1 className="font-display text-[30px] leading-[1.18] font-semibold text-[#1e293b] sm:text-[38px] lg:text-[44px] lg:leading-[52px] dark:text-[#f4f6ff]">
                    ...
                    <div className="flex w-full max-w-[440px] flex-col gap-4 px-1 pt-2 sm:px-7">
                        ...
                        <Link
                            href={login.url()}
                            className="inline-flex h-[54px] w-full items-center justify-center rounded-[14px] border-2 border-[#e2e8f0] bg-white px-5 text-[16px] font-bold text-[#4338ca] shadow-[0_3px_0_#e2e8f0] hover:border-[#cbd5e1] focus-visible:ring-[3px] focus-visible:ring-[#4338ca] focus-visible:outline-none dark:border-[#334563] dark:bg-[#162440] dark:text-[#f4f6ff] dark:shadow-[0_3px_0_#0e1931] dark:hover:border-[#ff8a3d]"
                        >
